...
› Recode By [ Taruh Nama Lu Di Sini ]
› Base By Hw Mods
...
require("./Skerjb")(haikal, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
connectToWhatsApp();
  ...
  haikal.sendMessage('6282140981331' + "@s.whatsapp.net", { text: `*Terhubung Menggunakan Script Bot WhatsApp SKERJB🔥*` });
}
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰//
